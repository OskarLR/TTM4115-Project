...
class TimerCommandSenderComponent:
    ...
    def create_gui(self):
        ...
        self.app.addButton('Unlock Scooter 1', on_button_pressed_unlock)
        self.app.addButton('Unlock Scooter 2', on_button_pressed_unlock)
        self.app.addButton('Unlock Scooter 3', on_button_pressed_unlock)
